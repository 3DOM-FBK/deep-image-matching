...
def main():
    ...
    parser.add_argument('-f', '--features', choices=['superglue', 'lightglue', 'loftr', 'detect_and_describe'])
    parser.add_argument('-n', '--max_feat_numb', type=int, required=True)
    ...
    max_feat_numb = args.max_feat_numb
