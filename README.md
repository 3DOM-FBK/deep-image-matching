...
| ------------------------------------       | ------------------------------------         | ------------------------------------           | ------------------------------------     |
| <img src='assets/matches_sift.gif' width="300"> | ![X2](assets/matches_joined.gif) width="300" | ![X3](assets/orientation_deep.gif) width="300" | ![X3](assets/roma_dense.gif) width="300" |
