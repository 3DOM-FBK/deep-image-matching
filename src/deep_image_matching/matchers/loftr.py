...
class LOFTRMatcher(DetectorFreeMatcherBase):
    ...
    Methods:
        ...
        _preprocess_input(self, image: np.ndarray, device: str = "cpu") -> torch.Tensor: Convert image to tensor.
    ...
    def _match_pairs(
        ...
        timg0_ = self._preprocess_input(image0_, self._device)
        timg1_ = self._preprocess_input(image1_, self._device)
    ...
    def _match_by_tile(
        ...
        for tidx0, tidx1 in tile_pairs:
            ...
            timg0_ = self._preprocess_input(tiles0[tidx0], self._device)
            timg1_ = self._preprocess_input(tiles1[tidx1], self._device)
    ...
    def _preprocess_input(self, image: np.ndarray, device: str = "cpu") -> torch.Tensor:
