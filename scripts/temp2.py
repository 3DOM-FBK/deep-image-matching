...
def plot_intensity_curve(image_path):
    ...
    plt.hist(filtered_data.flatten(), bins=256, range=[0,256], alpha=0.5, color='green', label='Filtered Data')
...
if __name__ == "__main__":
    ...
    image_path = r'C:\Users\threedom\Desktop\Neil\luca_all\images\11-12-22-313-radiometric.jpg'
