...
if __name__ == "__main__":
    ...
    out_dir = database_path.parent / "matches"
    ...
    if args.format == "colmap":
        ...
        raw_matches_file = out_dir / "raw_matches.txt"
        ...
        # Export raw matches
        out_matches_file = open(raw_matches_file, "w")
        for pair in raw_matches:
            out_matches_file.write(f"{pair}\n")
            tie_points = raw_matches[pair]
    ...
    if args.format == "x1y1x2y2":
        ...
        for pair in raw_matches:
            ...
            matches_file = out_dir / f"raw_{im1_no_format}_{im2_no_format}.txt"
            out_matches_file = open(matches_file, "w")
