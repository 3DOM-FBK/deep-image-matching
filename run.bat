...
REM python ./main.py  --config dedode --images C:\Users\lmorelli\Desktop\TESTS\nadar\images --outs assets/output --strategy sequential --overlap 1 --force


REM python ./main.py  --config se2loftr --images assets/example_sacre_coeur --outs assets/output --strategy bruteforce --force
python ./main.py  --config se2loftr --images assets/example_cyprus --outs assets/output --strategy bruteforce --force